...
function DashboardIcon(props: any) { return <Icon {...props}><svg><rect x="2" y="2" width="7" height="7" rx="1"/><rect x="11" y="2" width="7" height="7" rx="1"/><rect x="2" y="11" width="7" height="7" rx="1"/><rect x="11" y="11" width="7" height="7" rx="1"/></svg></Icon>; }
function CourseIcon(props: any) { return <Icon {...props}><svg><path d="M3 16.5A2.5 2.5 0 015.5 14H17"/><path d="M5.5 2H17v15H5.5A2.5 2.5 0 013 14.5v-12A2.5 2.5 0 015.5 2z"/></svg></Icon>; }
function AssignmentIcon(props: any) { return <Icon {...props}><svg><rect x="3" y="1.5" width="14" height="17" rx="2"/><path d="M7 6h6M7 10h6M7 14h4"/></svg></Icon>; }
function CalendarIcon(props: any) { return <Icon {...props}><svg><rect x="1.5" y="3" width="17" height="16" rx="2"/><path d="M1.5 7h17"/><path d="M6 1v4M14 1v4"/><path d="M6 11h2M10 11h2M14 11h2M6 14h2M10 14h2M14 14h2"/></svg></Icon>; }
function ChatIcon(props: any) { return <Icon {...props}><svg><path d="M3 1h14a2 2 0 012 2v10a2 2 0 01-2 2H7l-4 4V3a2 2 0 012-2z"/><path d="M6 7h8M6 10h6"/></svg></Icon>; }
function FolderIcon(props: any) { return <Icon {...props}><svg><path d="M1.5 4a1 1 0 011-1h5l2 2h7a1 1 0 011 1v10a1 1 0 01-1 1h-14a1 1 0 01-1-1V4z"/></svg></Icon>; }
function GradeIcon(props: any) { return <Icon {...props}><svg><path d="M10 1l2.5 5L18 6.5l-4 3.5 1 5.5L10 13l-5 2.5 1-5.5-4-3.5L7.5 6 10 1z"/></svg></Icon>; }
function SettingsIcon(props: any) { return <Icon {...props}><svg><circle cx="10" cy="10" r="2.5"/><path d="M10 1v3M10 16v3M1 10h3M16 10h3M4.5 4.5l2 2M13.5 13.5l2 2M4.5 15.5l2-2M13.5 6.5l2-2"/></svg></Icon>; }
function NotificationIcon(props: any) { return <Icon {...props}><svg><path d="M10 2a6 6 0 00-6 6c0 3-1 5-2 6h16c-1-1-2-3-2-6a6 6 0 00-6-6z"/><path d="M8 14a2 2 0 004 0"/></svg></Icon>; }
function HelpIcon(props: any) { return <Icon {...props}><svg><circle cx="10" cy="10" r="8"/><path d="M8 7.5a2 2 0 114 0c0 1.5-2 2-2 3.5"/><circle cx="10" cy="14" r="0.5" fill="currentColor"/></svg></Icon>; }
function GroupIcon(props: any) { return <Icon {...props}><svg><path d="M14 17v-1.5a3.5 3.5 0 00-3.5-3.5h-5A3.5 3.5 0 002 15.5V17"/><circle cx="7.5" cy="6" r="3.5"/><path d="M18 17v-1.5a3.5 3.5 0 00-2.5-3.4"/><circle cx="14" cy="6" r="3.5"/></svg></Icon>; }
function AnalyticsIcon(props: any) { return <Icon {...props}><svg><path d="M2 18h16"/><path d="M5 14l3-5 3 3 4-7"/><circle cx="5" cy="14" r="1.5" fill="currentColor"/><circle cx="11" cy="12" r="1.5" fill="currentColor"/><circle cx="15" cy="5" r="1.5" fill="currentColor"/></svg></Icon>; }
function UserIcon(props: any) { return <Icon {...props}><svg><path d="M16 17v-1a3 3 0 00-3-3H7a3 3 0 00-3 3v1"/><circle cx="10" cy="6" r="3"/></svg></Icon>; }
function BookmarkIcon(props: any) { return <Icon {...props}><svg><path d="M5 1h10a1 1 0 011 1v16l-6-4-6 4V2a1 1 0 011-1z"/></svg></Icon>; }
function ReportIcon(props: any) { return <Icon {...props}><svg><path d="M12 2H5a1 1 0 00-1 1v14a1 1 0 001 1h10a1 1 0 001-1V7l-4-5z"/><path d="M12 2v5h5"/><path d="M7 12h6M7 9h6M7 15h3"/></svg></Icon>; }
function CloudIcon(props: any) { return <Icon {...props}><svg><path d="M15 8.5A5 5 0 005 9a3.5 3.5 0 000 7h10a4 4 0 000-8z"/></svg></Icon>; }
function EducationIcon(props: any) { return <Icon {...props}><svg><path d="M10 1L1 6l9 5 9-5-9-5z"/><path d="M1 6v5"/><path d="M18 6v5"/><path d="M4 8.5v3.5l6 3 6-3V8.5"/></svg></Icon>; }
...
export const navItems: NavigationItem[] = [
  ...
  {
    id: 'admin', label: 'Administration', icon: SettingsIcon, href: '/admin', description: 'System administration', roles: ['admin'],
    children: [
