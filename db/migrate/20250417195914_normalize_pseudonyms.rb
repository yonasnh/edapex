...
class NormalizePseudonyms < ActiveRecord::Migration[7.1]
  ...
  def up
    ...
    # Temporarily commented out due to PostgreSQL syntax issues
    # execute(<<~SQL.squish)
    ...
    #     FOR EACH ROW
    #     EXECUTE FUNCTION #{connection.quote_table_name("pseudonyms_before_insert_or_update_enforce_unique_across_auth_providers__tr_fn")}()
    # SQL
